;-------------------------------------------------------------------------------
; Display a set of rectangles on a video display connected to an RCA CDP1861
...
landscape:  load  r7, $0000           ; draw border rectangle
            ...
            load  r7, $0808           ; draw rectangle inside first
            load  r8, $3030             
            call  gfx_draw_rect
            lbdf  error

            load  r7, $1010           ; draw rectangle inside second
            load  r8, $2020             
            call  gfx_draw_rect
            lbdf  error
            ...
            load  r7, $2F18           ; draw rectangle at bottom
            load  r8, $1010             
            call  gfx_draw_rect
            lbdf  error
